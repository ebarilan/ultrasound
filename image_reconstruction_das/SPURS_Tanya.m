function [ OutputImages, b_hat, uniform_k_samples] = SPURS_Tanya(b, Kappa_m, SPURS_settings)
...
% % %     %%%%%% Debug - lateral aliasing %%%%%%%%
% % %     apodWind = hamming(size(c,2)); 
% % %     figure; plot(apodWind);
% % %     apodMat = (repmat(apodWind,1,size(c,1))).';
% % %     figure; imagesc(apodMat);
% % %     
% % %     cApod = c.*apodMat;
% % %     figure; imagesc(abs(c));  figure; imagesc(abs(cApod)); 
% % %     
% % % %     c = cApos
% % %     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
